...
export const COLUMN_KEYS = {
  ...
  score: 'mainScore',
  clubName: 'mainTeams',
  liveHomeOdds: 'mainHomeOdds',
  liveDrawOdds: 'mainDrawOdds',
  liveAwayOdds: 'mainAwayOdds',
  onTarget: 'mainSonT',
  offTarget: 'mainSoffT',
  attacks: 'mainAttacks',
  dangerousAttacks: 'mainDangerousAttacks',
  attackConversion: 'mainAttackConversion',
  graphicalData1: 'mainGraph1',
  graphicalData2: 'mainGraph2',
  corners: 'mainCorners',
  possession: 'mainPossession',
  redCards: 'mainRedCards',
  yellowCards: 'mainYellowCards',
  lastOnTarget: 'previousSonT',
  lastOffTarget: 'previousSoffT',
  lastAttacks: 'previousAttacks',
  lastDangerousAttacks: 'previousDangerousAttacks',
  lastCorners: 'previousCorners',
  goals: 'previousGoals',
  pressureIndex: 'previousIntensity',
  momentum: 'miscMomentum',
  bell: 'miscFavourites',
  remove: 'miscDelete'
};

export const HIGHLIGHT_INFO = {
  attackLow: 1,
  attackHigh: 2,
  statLow: 3,
  statMedium: 4,
...
export const CHART_SETTINGS = {
  ...
  goal: 'rgb(49,233,3)',
  offTarget: 'purple',
  onTarget: 'rgb(137,231,248)',
}

export const MOMENTUM_WIDTH = 500;
export const GRID_ROW_HEIGHT = 60;
export const MAX_SPLINE_WIDTH = 500;
